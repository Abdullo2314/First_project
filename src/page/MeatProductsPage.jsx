...
function MeatProductsPage() {
    ...
    if (loading) {
        return <div className="text-center mt-10">Загрузка мясных продуктов...</div>;
    }

    return (
        <div className="container max-w-[1140px] mx-auto p-6">
            <h1 className="text-3xl font-bold mb-6">Мясные продукты</h1>
            {products.length === 0 ? (
...
export default MeatProductsPage;